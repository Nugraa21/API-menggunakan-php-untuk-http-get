...
// presensi_approve.php (standarisasi ke status, konsisten dengan absen_approve.php)
...
// pages/presensi_page.dart (tetap sama)
...
dan ini sql nya kamu bisa perbaiki pada bagian absensinya dan kalau mau menambah tabel atau yang lain 
